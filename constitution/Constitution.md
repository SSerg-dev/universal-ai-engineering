...
## 4. Scope of Constitutional Authority

This Constitution governs every architecture document, standard, methodology, template, reference asset, implementation, educational artifact, and supporting automation in the ecosystem.
...
## 6. Constitutional Rule #0

> No implementation may redefine the governing architecture.

When an implementation, methodology, template, book, reference asset, workflow, or tool conflicts with governing architecture, the subordinate artifact MUST be corrected unless the governing architecture is formally amended.
...
Universal AI Engineering MUST remain independent of any mandatory model, tool, IDE, cloud provider, or agent vendor.

## 14. Controlled Scope

New concepts must fit the existing architecture or justify an architectural change.
...
3. an Architectural Decision Record;
...
## 18. Ratification Status

This Constitution is Draft. It is not approved, stable, or ratified until explicitly approved by the accountable human authority.
